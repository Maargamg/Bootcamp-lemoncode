import  {score, actualizarScore} from './modelo';
import {generarNumeroAleatorio, dameNumeroCarta, damePuntosCarta, sumarPuntos,dameMensajePartidaCuandoMePlanto} from './motor';
